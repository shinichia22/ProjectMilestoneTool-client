...
class UpdateProject extends Component {
    ...
    constructor(){
        ...
        start_date: "",
        end_date: "",
        errors:{}           // we get this fromthe redux store mapStatToProps fucn  
     }
    }
    ...
    componentDidMount() {
        const {id} = this.props.match.params // this is from the props in react dev tools the id param is present in the match
...
UpdateProject.propTypes = {
  ...
  // form the combineReducers we take project and from that we take the state project
